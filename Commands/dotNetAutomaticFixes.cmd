...
CALL :run IDE2004 "Blank line not allowed after colon in constructor initializer (when configured)"
CALL :run IDE2005 "Blank line not allowed after token in conditional expression (when configured)"
CALL :run IDE2006 "Blank line not allowed after => token in arrow expression clause (when configured)"
