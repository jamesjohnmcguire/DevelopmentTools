...
INSERT INTO `wp_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES (1,'siteurl','http://localhost/wp','yes');
INSERT INTO `wp_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES (2,'home','http://localhost/wp','yes');
...
INSERT INTO `wp_users` (`ID`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `user_registered`, `user_activation_key`, `user_status`, `display_name`) VALUES (1,'Administrator','$P$BZJteZ.3xYVNZONKipA5XbzWYu8j.j.','administrator','jamesjohnmcguire@gmail.com','http://localhost/wp','2023-06-13 09:05:45','',0,'Administrator');
